...
(define-type Type (U numT boolT strT voidT funT))
...
;;parse the lamC into two different lists, list of types and ids
;;TYPE-PARSE

;; work on the parser and type environment!
...
;; LOOKUPTYPE
;;-----------------------------------------------------------------------------------
;; Helper that looks up a type in an environment
